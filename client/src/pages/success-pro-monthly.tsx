...
import { CheckCircle, ArrowRight, Crown, BarChart3, Sparkles } from "lucide-react";

export default function SuccessProMonthly() {
        ...
        <CardContent className="p-8 text-center">
          ...
          <div className="mb-6">
            ...
            <p className="text-slate-300">
              Bienvenue dans le plan Pro mensuel
            </p>
          </div>
          ...
          <div className="bg-white/5 rounded-lg p-6 mb-6">
            <div className="flex items-center justify-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-white">Plan Pro</h2>
              <div className="ml-2 px-2 py-1 bg-emerald-500/20 rounded text-xs text-emerald-300">
                79€/mois
              </div>
            </div>
          ...
          <div className="space-y-4">
            <p className="text-slate-300 mb-6">
              Votre abonnement Pro est maintenant actif. Exploitez tout le potentiel de LeadPilot !
            </p>
